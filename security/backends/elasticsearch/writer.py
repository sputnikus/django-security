...
from .models import (
    ...
    get_key_from_content_type_object_id_and_model_db, get_response_state, get_log_model_from_logger_name, get_object_triple_from_key,
...
class LogstashElasticsearchDataWriter(BaseElasticsearchDataWriter):
    ...
    def _get_log_message(self, logger_id, logger_name, version, data):
        return '{} {} {} {}'.format(
            ...
            version,
            logger_id,
            self._serialize_data(self._update_data(data))
        )
