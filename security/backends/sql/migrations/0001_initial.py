    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_data', models.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='response headers')),
                ...
                ('celery_task_id', models.UUIDField(blank=True, db_index=True, null=True, verbose_name='invocation ID')),
                ...
                ('task_args', models.JSONField(blank=True, editable=False, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='task args')),
                ('task_kwargs', models.JSONField(blank=True, editable=False, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='task kwargs')),
                ('estimated_time_of_first_arrival', models.DateTimeField(blank=True, null=True, verbose_name='estimated time of first arrival')),
                ...
                ('state', enumfields.fields.NumEnumField(db_index=True, default=1, enum=security.enums.CeleryTaskInvocationLogState, verbose_name='state')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_args', models.JSONField(blank=True, editable=False, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='task args')),
                ('task_kwargs', models.JSONField(blank=True, editable=False, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='task kwargs')),
                ('state', enumfields.fields.NumEnumField(db_index=True, default=1, enum=security.enums.CeleryTaskRunLogState, verbose_name='state')),
                ('result', models.JSONField(blank=True, editable=False, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='result')),
                ...
                ('estimated_time_of_next_retry', models.DateTimeField(blank=True, null=True, verbose_name='estimated time of arrival')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_executed_from_command_line', models.BooleanField(default=False, editable=False, verbose_name='is executed from command line')),
                ('output', models.TextField(blank=True, editable=False, null=True, verbose_name='output')),
                ('state', enumfields.fields.NumEnumField(db_index=True, default=1, enum=security.enums.CommandState, verbose_name='state')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queries', models.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='queries')),
                ('is_secure', models.BooleanField(default=False, verbose_name='HTTPS connection')),
                ('request_headers', models.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='request headers')),
                ...
                ('response_headers', models.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='response headers')),
                ('response_body', models.TextField(blank=True, null=True, verbose_name='response body')),
                ('state', enumfields.fields.NumEnumField(default=0, enum=security.enums.RequestLogState, verbose_name='state')),
                ...
                ('view_slug', models.CharField(blank=True, db_index=True, max_length=255, null=True, verbose_name='view slug')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('output_request_log', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='_related_objects', related_query_name='related_objects', to='security_backends_sql.outputrequestlog')),
            ],
            options={
                'db_tablespace': '',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_ct_id', models.PositiveSmallIntegerField(db_index=True, verbose_name='content type of the related object')),
                ('object_id', models.TextField(db_index=True, verbose_name='ID of the related object')),
                ('input_request_log', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='_related_objects', related_query_name='related_objects', to='security_backends_sql.inputrequestlog')),
            ],
            options={
                'db_tablespace': '',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_ct_id', models.PositiveSmallIntegerField(db_index=True, verbose_name='content type of the related object')),
                ('object_id', models.TextField(db_index=True, verbose_name='ID of the related object')),
                ('command_log', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='_related_objects', related_query_name='related_objects', to='security_backends_sql.commandlog')),
            ],
            options={
                'db_tablespace': '',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_ct_id', models.PositiveSmallIntegerField(db_index=True, verbose_name='content type of the related object')),
                ('object_id', models.TextField(db_index=True, verbose_name='ID of the related object')),
                ('celery_task_run_log', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='_related_objects', related_query_name='related_objects', to='security_backends_sql.celerytaskrunlog')),
            ],
            options={
                'db_tablespace': '',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_ct_id', models.PositiveSmallIntegerField(db_index=True, verbose_name='content type of the related object')),
                ('object_id', models.TextField(db_index=True, verbose_name='ID of the related object')),
                ('celery_task_invocation_log', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='_related_objects', related_query_name='related_objects', to='security_backends_sql.celerytaskinvocationlog')),
            ],
            options={
                'db_tablespace': '',
