...
class InputRequestsLogISCore(RequestsLogISCore):
    ...
    ui_list_fields = (
        'id', 'created_at', 'changed_at', 'start', 'stop', 'time', 'state',
    ...
    form_fieldsets = (
        (_('Request'), {'fields': ('created_at', 'changed_at', 'start', 'host', 'method', 'path',
...
class OutputRequestsLogISCore(RequestsLogISCore):
    ...
    form_fieldsets = (
        ...
        (_('Response'), {'fields': ('stop', 'response_code', 'state', 'response_headers',
                                    'response_body_code', 'error_message_code')}),
        (_('Extra information'), {'fields': ('slug', 'time', 'display_related_objects', 'display_source')}),
    )
...
class CommandLogISCore(SecurityISCoreMixin, UIRESTModelISCore):
    ...
    ui_list_fields = (
        'id', 'created_at', 'changed_at', 'name', 'start', 'stop', 'time', 'executed_from_command_line', 'state'
    )
    ...
    form_fieldsets = (
        (None, {'fieldsets': (
            (None, {
                'fields': (
                    'created_at', 'changed_at', 'name', 'input', 'error_message_code', 'display_related_objects',
            ...
            (None, {
                'fields': ('start', 'stop', 'time', 'executed_from_command_line', 'state'),
                'class': 'col-sm-6'
            })
        ),}),
...
class CeleryTaskInvocationTableView(InlineTableView):
    ...
    fields = (
        'id', 'celery_task_id', 'created_at', 'changed_at'
    )
...
class CeleryTaskRunLogISCore(SecurityISCoreMixin, UIRESTModelISCore):
    ...
    ui_list_fields = (
        'id', 'celery_task_id', 'created_at', 'changed_at',  'state', 'start', 'stop', 'time', 'retries'
    )

    form_fieldsets = (
        (None, {
            'fields': (
                'celery_task_id', 'start', 'stop', 'time', 'state', 'result', 'error_message_code', 'output_html',
                'retries', 'estimated_time_of_next_retry', 'display_related_objects',
...
class CeleryTaskInvocationLogISCore(SecurityISCoreMixin, UIRESTModelISCore):
    ...
    ui_list_fields = (
        'id', 'celery_task_id', 'created_at', 'changed_at', 'name', 'short_input', 'state', 'get_start',
        'get_stop', 'queue_name'
    )
