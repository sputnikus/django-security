...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reversion_log_requestrevision', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('logged_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['security.LoggedRequest'])),
            ('revision', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['reversion.Revision'], unique=True)),
        ))
        db.send_create_signal(u'reversion_log', ['RequestRevision'])


    def backwards(self, orm):
        # Deleting model 'RequestRevision'
        db.delete_table(u'reversion_log_requestrevision')
    ...
    models = {
        ...
        u'reversion_log.requestrevision': {
            'Meta': {'object_name': 'RequestRevision'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logged_request': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['security.LoggedRequest']"}),
