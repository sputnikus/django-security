# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2018-03-07 13:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('command_name', models.CharField(db_index=True, editable=False, max_length=250, verbose_name='command name')),
                ('command_options', models.TextField(editable=False, verbose_name='command options')),
                ('executed_from_command_line', models.BooleanField(default=False, editable=False, verbose_name='executed from command line')),
                ('output', models.TextField(blank=True, editable=False, null=True, verbose_name='command output')),
                ('is_successful', models.BooleanField(default=False, editable=False, verbose_name='finished successfully')),
            ],
            options={
