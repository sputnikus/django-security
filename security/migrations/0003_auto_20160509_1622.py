...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=json_field.fields.JSONField(blank=True, default='null', help_text='Enter a valid JSON object', null=True, verbose_name='request headers'),
        ),
        ...
        migrations.AlterModelOptions(
            ...
            options={'ordering': ('-request_timestamp',), 'verbose_name': 'input logged request', 'verbose_name_plural': 'input logged requests'},
        ),
        migrations.AddField(
            model_name='inputloggedrequest',
            name='exception_name',
        ...
        migrations.AddField(
            ...
            field=json_field.fields.JSONField(blank=True, default='null', help_text='Enter a valid JSON object', null=True, verbose_name='response headers'),
        ),
        migrations.AlterField(
            model_name='inputloggedrequest',
        ...
        migrations.AlterField(
            model_name='inputloggedrequest',
            name='queries',
            field=json_field.fields.JSONField(blank=True, default='null', help_text='Enter a valid JSON object', null=True, verbose_name='queries'),
        ),
        migrations.AlterField(
            model_name='inputloggedrequest',
            name='request_body',
        ...
        migrations.AlterField(
            model_name='inputloggedrequest',
            name='status',
            field=models.PositiveSmallIntegerField(choices=[(20, 'Info'), (30, 'Warning'), (40, 'Error'), (10, 'Debug'), (50, 'Critical')], verbose_name='status'),
        ),
        migrations.AlterField(
            model_name='inputloggedrequest',
            name='type',
            field=models.PositiveSmallIntegerField(choices=[(1, 'Common request'), (2, 'Throttled request'), (3, 'Successful login request'), (4, 'Unsuccessful login request')], default=1, verbose_name='type'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queries', json_field.fields.JSONField(blank=True, default='null', help_text='Enter a valid JSON object', null=True, verbose_name='queries')),
                ...
                ('request_headers', json_field.fields.JSONField(blank=True, default='null', help_text='Enter a valid JSON object', null=True, verbose_name='request headers')),
                ...
                ('response_headers', json_field.fields.JSONField(blank=True, default='null', help_text='Enter a valid JSON object', null=True, verbose_name='response headers')),
                ('response_body', models.TextField(blank=True, null=True, verbose_name='response body')),
                ('status', models.PositiveSmallIntegerField(choices=[(20, 'Info'), (30, 'Warning'), (40, 'Error'), (10, 'Debug'), (50, 'Critical')], verbose_name='status')),
                ('error_description', models.TextField(blank=True, null=True, verbose_name='error description')),
                ('exception_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='exception name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('output_logged_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_objects', to='security.OutputLoggedRequest', verbose_name='output logged requests')),
            ],
        )
    ]
