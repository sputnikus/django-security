...
from security.backends import is_processing_celery_task
...
class LoggedTask(DjangoTask):
    ...
    def expire_invocation(self, invocation_log_id, logger_data):
    ...
    def is_processing(self, related_objects=None):
        return is_processing_celery_task(self.name, related_objects)
