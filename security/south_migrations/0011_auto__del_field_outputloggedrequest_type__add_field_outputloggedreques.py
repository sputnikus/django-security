...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OutputLoggedRequest.type'
        db.delete_column(u'security_outputloggedrequest', 'type')

        # Adding field 'OutputLoggedRequest.slug'
        db.add_column(u'security_outputloggedrequest', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OutputLoggedRequest.type'
        db.add_column(u'security_outputloggedrequest', 'type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'OutputLoggedRequest.slug'
        db.delete_column(u'security_outputloggedrequest', 'slug')
